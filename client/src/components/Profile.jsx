        ...
        <>
            <div className='my-5'>
                <form className="px-3 container card card-body" style={{ maxWidth: "540px" }}>
                    ...
                    <div className="row">
                        <div className="col-12 col-md-6"><input type="email" name="Email" value={userData.Email} className="form-control mb-2" placeholder="E-mail" readOnly /></div>
                    ...
                    <div className="row">
                        <div className="col-12 col-md-6"><input type="text" name="District" value={userData.District} className="form-control mb-2 mr-auto" placeholder="District" readOnly /></div>
                        <div className="col-12 col-md-6"><input type="text" name="State" value={userData.State} className="form-control mb-2 mr-auto" placeholder="State" readOnly /></div>
                    </div>
                    <div className="row">
                        <div className="col-12 col-md-6"><input type="number" name="Pincode" value={userData.Pincode} className="form-control mb-2" placeholder="Pincode" readOnly /></div>
                        <div className="col-12 col-md-6"><input type="number" name="Phone" value={userData.Phone} className="form-control mb-2" placeholder="Phone number" readOnly /></div>
                    </div>
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <form className="px-3 container card card-body" style={{ maxWidth: "540px" }}>
                        ...
                        <div className="row">
                            <div className="col-12 col-md-6"><input type="email" name="Email" value={userData.Email} className="form-control mb-2" placeholder="E-mail" readOnly onChange={handleChange} /></div>
                        ...
                        <div className="row">
                            <div className="col-12 col-md-6"><input type="text" name="District" value={userData.District} className="form-control mb-2 mr-auto" placeholder="District" onChange={handleChange} /></div>
                            <div className="col-12 col-md-6"><input type="text" name="State" value={userData.State} className="form-control mb-2 mr-auto" placeholder="State" onChange={handleChange} /></div>
                        </div>
                        <div className="row">
                            <div className="col-12 col-md-6"><input type="number" name="Pincode" value={userData.Pincode} className="form-control mb-2" placeholder="Pincode" onChange={handleChange} /></div>
                            <div className="col-12 col-md-6"><input type="number" name="Phone" value={userData.Phone} className="form-control mb-2" placeholder="Phone number" onChange={handleChange} /></div>
                        </div>
                    </form>
                </Modal.Body>
                <Modal.Footer>
